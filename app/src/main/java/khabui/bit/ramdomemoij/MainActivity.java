package khabui.bit.ramdomemoij;
        ...
        myGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (iconClicked.getText().toString() == mainIconSt) {
                    ...
                    mainIconSt = RandomIcon();
                    if (myListTmp.size()==0) {
                        Toast.makeText(MainActivity.this, "Thang roi", Toast.LENGTH_SHORT).show();
                    }
                }
                else {
                    Toast.makeText(MainActivity.this, "Sai roi ban e", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
